        ...
        <Card className={ classes.cardContainer }>
            ...
            <CardContent>
                <Box display="flex" justifyContent="center" alignItems="center">
                    ...
                    <input ref={ uploadFile } type="file" id="uploadImage" onChange={ changeAvatar }  style={{ display: "none" }}/>
                        {!globalState.state.credentials || loading ? 
                        (
                            <Skeleton variant="circle" className={  classes.avatar } />
                        )
                        :
                        (
                        !globalState.state.credentials.imageUrl ?
                            (<Skeleton variant="circle" className={  classes.avatar } />)
                            :
                            (<Badge
                                overlap="circle"
                                ...
                                <Avatar className={ classes.avatar } alt="" src={globalState.state.credentials.imageUrl}/> 
                            </Badge>)
                        )
                        }
                    </div>
            ...
            <CardContent >
                <Box className={ classes.boxItem } display="flex" justifyContent="center">
                    { !globalState.state.credentials ? 
                    (
                        <Skeleton variant="text" width={200} height={25} />
                    )
                    :
                    (<Typography color="secondary" variant="h5">
                        @{globalState.state.credentials.handle}
                    </Typography>)
                    }
                </Box>
                <Box display="flex" justifyContent="center" alignItems="center" className={ classes.boxItem }>
                    ...
                    (<Typography className={ classes.intro } align="center" color="textPrimary" variant="body1">
                        {globalState.state.credentials.bio}
                    </Typography>)
                    }
                </Box>
                    ...
                    (
                        <React.Fragment>
                            ...
                            <Typography align="center" color="textPrimary" variant="body2">
                                {globalState.state.credentials.location}
                            </Typography>
                        </React.Fragment>
                    )
                    }
                ...
                <Box className={ classes.boxItem } display="flex" justifyContent="center" alignItems="center">
                    ...
                    (
                        <React.Fragment>
                            ...
                            <Typography align="center" color="textPrimary" variant="body2">
                                {globalState.state.credentials.website}
                            </Typography>
                        </React.Fragment>
                    )}
                </Box>
                <Box className={ classes.boxItem } display="flex" justifyContent="center" alignItems="center">
                    ...
                    (
                        <React.Fragment>
                            ...
                            <Typography align="center" color="textPrimary" variant="body2">
                                Joined, {dayjs(globalState.state.credentials.createdAt).fromNow()}
                            </Typography>
                        </React.Fragment>
                    )}
                </Box>
